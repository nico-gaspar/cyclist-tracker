...
const createTimelineDataForYears = (startYear, endYear) => {
  const data = [];
...
export const GanttProvider = ({
  ...
  const [timelineData, setTimelineData] = useState(() => {
    if (timelineDataProp && timelineDataProp.length) {
      return timelineDataProp;
    }
  ...
  useEffect(() => {
    if (timelineDataProp && timelineDataProp.length) {
      setTimelineData(timelineDataProp);
    }
  }, [timelineDataProp]);
  ...
  }, 100), [bounded, timelineData, setScrollX]);
